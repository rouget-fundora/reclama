...
<body id="main_body" >
	...
	<div class="col-md-6">		
<form name="finicio" action="/inserta.php" method="post" onSubmit="return validar ()"> <div class="form_description"></div>						
	  <div class="form-group">
			...
			<div class="form-group">
				<input type="text" class="form-control" name="processo" id="processo" placeholder="Número de Processo" required>
				 </div>
				 
			<div class="form-group">
				<input type="text" class="form-control" name="bi" id="bi" placeholder="Bilhete de Identidade" required>
				 </div>
			...
			<div class="form-group">
				<textarea rows="6" cols="100" class="form-control" name="message" id="message" placeholder="Messagem" required></textarea>
				 </div> 
					...
					<button type="submit" name="Submit" id="feedbackSubmit" class="btn btn-success btn-sm col-md-1" style="display:; margin-top: 11px; width:150px; height:34px" >Enviar</button>
